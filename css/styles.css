...
/* ==========================================================================
   OCULTAR SCROLLBARS EN PWA (WINDOWS/MAC)
   ========================================================================== */
...
/* Oculta barra en Chrome, Edge, Safari (WebKit) */
...
@media (max-width: 480px) {
    ...
    /* --- 3. SELECTOR DE CANCIONES --- */
    .station-selector { margin-bottom: 20px; }
    .custom-select-trigger { padding: 10px; font-size: 14px; }
    .custom-option { padding: 8px; }

    /* --- 4. ALBUM Y NOW PLAYING --- */
    .album-cover { width: 80px; height: 80px; }
    .now-playing-container { gap: 10px; }
    .now-playing { padding: 10px; border-radius: 10px; }
    .now-playing-label { font-size: 10px; }

    .song-title { font-size: 15px; }
    .song-artist { font-size: 13px; }
    .song-album { font-size: 11px; }

    /* --- 5. COUNTDOWN Y DETALLES --- */
    .countdown-container {
        padding: 8px;
        height: auto;
        min-height: 120px;
    ...
    .countdown-timer-column { width: 80px; }
    .countdown-label { font-size: 9px; }
    .countdown-timer { font-size: 13px; }

    .album-details-column { padding-left: 10px; }
    .details-row { gap: 5px; }
    .details-label { min-width: 50px; font-size: 9px; }
    .details-value { font-size: 11px; line-height: 1.2; }

    /* --- 6. TAGS Y BOTONES --- */
    .station-tags { gap: 4px; margin-top: 8px; }
    .station-tag { font-size: 10px; padding: 2px 6px; }
    ...
    /* ==========================================================================
      CORRECCIÓN CRÍTICA BOTÓN COMPARTIR (MÓVIL)
   ========================================================================== */
    
   /* 1. Evitamos que el contenedor del header se encoja a 0 */
    .now-playing-header {
        min-width: auto; /* Anula el min-width: 0 de la clase base */
        width: 100%;
    }

    /* 2. Forzamos que el botón siempre tenga ancho */
    .share-button {
        opacity: 1 !important;
        visibility: visible !important;
        
        display: flex; /* Mantener flex para centrar el icono */
        flex-shrink: 0; /* No encogerse */
        
        /* CLAVE: Anulamos el min-width: 0 de la clase base */
        min-width: auto; 
        
        /* Damos un área de toque mínima segura para el dedo */
        width: 35px;
        height: 35px;
        min-height: 35px;
        
        padding: 5px; /* Espacio alrededor del icono */
        background-color: rgba(255, 255, 255, 0.1); /* Fondo sutil para localizarlo */
        border-radius: 4px;
        z-index: 5;
    }
    ...
    .share-button svg {
        width: 20px; /* Icono más grande y visible */
        height: 20px;
    }
...
.smart-link-btn {
    ...
    /* Estilos visuales ajustados a tu tema actual */
    padding: 2px;
...
.smart-link-btn.mobile-os .smart-link-text {
    display: none;
}

.smart-link-btn.mobile-os {
    padding: 2px; /* Un poco más chico verticalmente si solo muestra el emoji */
}

@media (max-width: 500px) { .smart-link-text { display: none; } }
