...
document.addEventListener('DOMContentLoaded', () => {
    try {
        ...
        document.addEventListener('keydown', function(event) {
            // Solo actuar si el selector está cerrado y no estamos en un input
            if (!document.querySelector('.custom-select-wrapper.open') &&
                ...
                // --- NUEVO: LÓGICA DEL INDICADOR VISUAL ---
                ...
                indicator.textContent = key.toUpperCase(); // Muestra la letra (ej: "A")
                indicator.classList.add('visible');
                
                // Ocultar automáticamente después de 800ms
                clearTimeout(wrapper.keyIndicatorTimeout); // Limpia temporizador anterior
                wrapper.keyIndicatorTimeout = setTimeout(() => {
                    indicator.classList.remove('visible');
                }, 800);
                // --- FIN LÓGICA INDICADOR ---
                ...
                if (matches.length > 0) {
                    ...
                    // Evitar recargar si es la misma estación
